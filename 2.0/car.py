...
class Car:
	#lock...Lenkeinschlag
	def __init__ (self,mass,power,currentSpeed,maxSpeed,x,y,currentLock, maxLock, orientation, innerPoly, outerPoly):
		self.mass = mass
		self.power = power
		...
		self.innerPoly = innerPoly
		self.outerPoly = outerPoly
	...
	def nextPos(time):
		...
		if collision(self.innerPoly, (self.x, self.y), (x2, y2)) and collision(self.outerPoly, (self.x, self.y), (x2, y2)):	
			car.updatePosition(x2, y2, (Car.orientation + eps))	
		else:
			print "HURNS WAND!"
